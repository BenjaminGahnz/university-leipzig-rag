...
def main(start_url, max_depth=20):
    ...
    base_dir = "Prüfungs-, Studien- und Eignungsfeststellungsordnungen"
...
if __name__ == "__main__":
    #! Change the start_url to your desired page / if its an List change starting directory code
    start_url = 'https://amb.uni-leipzig.de/startseite-bekanntmachungen.html?kat_id=2001'
